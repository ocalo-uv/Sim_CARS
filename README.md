...
1. **Clonar el repositorio:**
   ```bash
   git clone [https://github.com/ocalo-uv/Sim_CARS.git](https://github.com/ocalo-uv/Sim_CARS.git)
...
Desarrollado con 💛 por OCalderonL - Universidad del Valle
